...
export const config: Options.Testrunner = {
    ...
    KEY = 'Ow50bDT0v9NvjXU7TERXRaay1W4PjpjtCitjxhTnCREiekVIxV',
    ...
    capabilities: [
      ...
      */
            ...
            'platform': 'Windows 10',
            'resolution': '1024x768',
            // 'build': 'Lambdatest-Javascript-Sample-Build', // CI/CD job or build name
            // 'name': 'Javascript-Sample-Test', // Test name
            browserName: 'chrome',
            "goog:chromeOptions": {
                args:
